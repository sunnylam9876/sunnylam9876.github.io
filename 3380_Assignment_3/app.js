...
const Planet = (props) => {
  return (
    <div className="card">
      <button className="remove-planet" onClick={() => props.removePlanet(props.id)}>X</button>
  ...
  render() {
    return (
      <div className="container">
        {this.state.planets.map(eachPlanet => 
            <Planet
              id={eachPlanet.id}
              name={eachPlanet.name}
              diameter={eachPlanet.diameter}
              moons={eachPlanet.moons}
              desc={eachPlanet.desc}
              url={eachPlanet.url}
              key={eachPlanet.id.toString()}
